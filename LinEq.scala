...
Фадеев.
Лабораторная 4:
Класс LinEq[T], представляющий линейное неравенство вида
a_1*x_1 + a_2*x_2 + . . . + a_n*x_n < b с операцией, проверяющей,
удовлетворяет ли заданный список значений переменных
неравенству. Коэффициенты неравенства, а также значения
переменных имеют тип T, который либо является числовым, либо
булевским. Для булевского типа умножение – это конъюнкция,
